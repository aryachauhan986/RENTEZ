...
import { GiHamburgerMenu } from "react-icons/gi";  //icons from react icons 
...
export default function Nav() {
    ...
    //to handle logut functionality function
  ...
  return (
    <div className='fixed top-0 bg-[white] z-[20]'>
        ...
        <div className='w-[35%] relative hidden md:block '>
            <input type="text" className='w-[100%] px-[30px] py-[10px] border-[2px] border-[#bdbaba] outline-none overflow-auto rounded-[30px] text-[17px]' placeholder='Any Where | Any Location | Any City' onChange={(e)=>{
               setInput(e.target.value)
            }} value={input}/>
            <button className='absolute p-[10px] rounded-[50px] bg-[red] right-[3%] top-[5px]'><MdOutlineSearch className='w-[20px] h-[20px] text-[white]'/></button>
        </div>
        ...
        <div className='flex items-center justify-center gap-[10px] relative'>
            ...
            border-[1px] border-[#8d8c8c] rounded-[50px] hover:shadow-lg' onClick={()=>{setShowpopup(!showpopup)}}>
               <span><GiHamburgerMenu className='w-[20px] h-[20px]'/></span> {userData==null && <span><CgProfile className='w-[23px] h-[23px]'/></span>}
    ...
    {/* search comes when the width reduced too much for phone like */}
    ...
    {/* second nav all icons here like flat rooms */}
