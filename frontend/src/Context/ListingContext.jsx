...
export default function ListingContext({children}) {
    ...
    let [newListData,setNewListData]=useState([]);//used for filtering the listing at each svg
    ...
    useEffect(()=>{
      getListing();
    },[adding,updating,deleting]); //when any of the value updating and adding change then this ueseffect will run
