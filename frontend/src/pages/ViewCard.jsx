...
export default function ViewCard() {
    ...
    let [title,setTitle]=useState(cardDetails.title);//hooks to show previous value in update listing page
    ...
    const handleImage1=(e)=>{
         ...
         useEffect(()=>{
           let today=new Date().toISOString().split('T')[0]; //ISO means fetch date according to international time 
           setMinDate(today);
         },[]);
                 ...
                 <div className='w-[95%] h-[400px] flex items-center justify-center flex-col md:w-[80%] md:flex-row '>
                  ...
                  <div className='w-[95%] flex items-start justify-start text-[18px] md:w-[80%] md:text-[25px]'>
                     ...
                     <div className='w-[95%] h-[50px] flex items-center justify-start px-[110px] '>
                      {cardDetails.host==userData._id && <button className='px-[30px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg text-nowrap' onClick={()=>{setUpdatePopUp(prev=>!prev)}}>
                        Edit
                      </button>}
                      ...
                      {updatePopUp && <div className='w-[100%] h-[100%] flex items-center justify-center bg-[#000000c6]  absolute top-[0px] z-[100] backdrop-blur-sm'>
                         <RxCross2 className='w-[40px] h-[40px] bg-[red] cursor-pointer absolute top-[6%] left-[25px] rounded-[50%] flex items-center justify-center' onClick={()=>setUpdatePopUp(false)}/>
                          ...
                          <form action="" className='max-w-[900px] w-[90%] h-[550px] flex items-center justify-start  flex-col  gap-[10px] overflow-auto mt-[50px] text-[white] bg-[#272727] p-[20px] rounded-lg' onSubmit={(e)=>{e.preventDefault()}}>
                                    ...
                                    <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                                          ...
                                          <input type="text" id='title'  className='w-[90%] h-[40px] border-[2px] border-[#555666] rounded-lg text-[18px] px-[11px] text-[black]' placeholder='_Bhk house or best title ' onChange={(e)=>setTitle(e.target.value)} value={title}/>
                                          </div>
                                     
                                     <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                                          <label htmlFor="description" className='text-[20px]'>Description</label>
                                          <textarea id='description'  className='w-[90%] h-[70px] border-[2px] border-[#555666] rounded-lg text-[18px] px-[11px] text-[black]' required onChange={(e)=>setDescription(e.target.value)} value={description}/>
                                          </div>
                                      ...
                                      <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                                          ...
                                          <input type="number" id='rent'  className='w-[90%] h-[40px] border-[2px] border-[#555666] rounded-lg text-[18px] px-[11px] text-[black]' required  placeholder='Rs.___/day' onChange={(e)=>setRent(e.target.value)} value={rent}/>
                                          </div>
                          
                                          <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                                          <label htmlFor="city" className='text-[20px]'>City</label>
                                          <input type="text" id='city'  className='w-[90%] h-[40px] border-[2px] border-[#555666] rounded-lg text-[18px] px-[11px] text-[black]' required  placeholder='City,Country' onChange={(e)=>setCity(e.target.value)} value={city}/>
                                          </div>
                          
                                          <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                                          <label htmlFor="landmark" className='text-[20px]'>LandMark</label>
                                          <input type="text" id='landmark'  className='w-[90%] h-[40px] border-[2px] border-[#555666] rounded-lg text-[18px] px-[11px] text-[black]' required onChange={(e)=>setLandmark(e.target.value)} value={landmark}/>
                                          </div>
                                          ...
                                          <button className=' px-[10px] py-[10px] bg-[red] text-[white] text-[15px] md:px-[100px] rounded-lg md:text-[18px] text-nowrap' onClick={handleDeleteListing} disabled={deleting}>{deleting?"Deleting..":"Delete Listing"}</button>
                                          </div>
                      ...
                      {bookingPopUp && <div className='w-[100%] min-h-[100%]  flex items-center justify-center flex-col gap-[30px] bg-[#ffffffcd] absolute top-[0px] z-[100] p-[20px] backdrop-blur-sm md:flex-row md:gap-[100px]'>
                        <RxCross2 className='w-[40px] h-[40px] bg-[red] cursor-pointer absolute top-[6%] left-[25px] rounded-[50%] flex items-center justify-center' onClick={()=>setBookingPopUp(false)}/>

                          <form className='max-w-[450px] w-[90%] h-[450px] overflow-auto bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-center flex-col gap-[8px] border-[1px] border-[#dedddd]' onSubmit={(e)=>e.preventDefault()}>
                              <h1 className='w-[100%] flex items-center justify-center py-[5px] text-[25px] border-b-[1px] border-[#a3a3a3]'>confirm & Book</h1>
                              <div className='w-[100%] h-[70%]  mt-[10px] rounded-lg p-[10px]'>
                                ...
                                <div className='w-[90%] flex items-center justify-start  gap-[24px] mt-[20px] md:items-start md:justify-center flex-col md:flex-row'>
                                          ...
                                          <input type="date" 
                                          min={minDate} id='checkIn'  className='border-[#555656] border-2 w-[200px] h-[40px] rounded-[10px] bg-transparent px-[10px] text-[15px] md:text-[18px]' required onChange={(e)=>setCheckIn(e.target.value)} value={checkIn}/>
                                          </div>
                              <div className='w-[90%] flex items-center justify-start  gap-[10px] mt-[40px] md:justify-center flex-col md:flex-row md:items-start'>
                                          ...
                                          <input type="date" min={minDate} id='checkOut'  className='border-[#555656] border-2 w-[200px] h-[40px] rounded-[10px] bg-transparent px-[10px] text-[15px] md:text-[18px]' required onChange={(e)=>setCheckOut(e.target.value)} value={checkOut}/>
                                           ...
                                           <button className=' px-[80px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg text-nowrap mt-[30px]'  onClick={()=>handleBooking(cardDetails._id)}
                                            disabled={booking}>{booking?"Booking...":"Book Now"}</button>
                                           </div>
                          ...
                          <div className='max-w-[450px] w-[90%] h-[450px] bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-center flex-col gap-[10px] border-[1px] border-[#e2e1e1]'>
                              <div className='w-[95%] h-[30%] border-[1px] border-[#9b9a9a] rounded-lg flex justify-center items-center gap-[8px] p-[20px] overflow-hidden'>
                                <div className='w-[70px] h-[90px] flex items-center justify-center flex-shrink-0 rounded-lg md:w-[100px]'><img src={cardDetails.image1} alt="" className='w-[100%] h-[100%] rounded-lg'/></div>
                                <div className='w-[80%] h-[100px] gap-[5px]'>
                                  ...
                                  {/* truncate have three properties in it text-nowrap,text-ellipsis,overflow-hidden */}
